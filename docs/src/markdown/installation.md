...
The recommended way to install ThemeScheduler is via [Package Control](https://packagecontrol.io/).  Package Control
...
<kbd>shift</kbd> + <kbd>p</kbd> (OSX) to bring up the quick panel and start typing
...
/// warning | Warning
This is not the recommended way to install ThemeScheduler for the casual user as it requires the user to know which
